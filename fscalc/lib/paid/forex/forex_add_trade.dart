...
class ForexAddTrade extends StatefulWidget {
  const ForexAddTrade({Key? key}) : super(key: key);

  @override
  State<ForexAddTrade> createState() => _ForexAddTradeState();
}

class _ForexAddTradeState extends State<ForexAddTrade> {
  ...
  Future entryDateTimePicker() async {
    MaterialColor colorCustom = MaterialColor(0xffB61131, _materialColor);
    ...
    DateTime? newDateTime = await showRoundedDatePicker(
      ...
      styleYearPicker: MaterialRoundedYearPickerStyle(
        textStyleYear: const TextStyle(fontSize: 40, color: kThemeRed),
                    ...
                    children: [
                      Container(
                        ...
                        child: DropdownButtonFormField2(
                          ...
                          iconOnClick: const Icon(Icons.expand_less_rounded),
                          iconSize: 34,
                          buttonHeight: 60,
                          buttonPadding:
                      ...
                      Obx(
                        () => ListTile(
                          title: const Text("Are you still in this position?"),
                          trailing: Switch.adaptive(
                            value: _forexController.isOpen.value,
                            activeColor: kThemeRed.withOpacity(0.7),
                            onChanged: (val) => _forexController.toggleIsOpen(),
                          ),
                        ),
                      ),
                      ...
                      GetX<ForexController>(
                        builder: (controller) {
                          return controller.isOpen.isTrue
                              ? const SizedBox()
                              : AnimatedOpacity(
                                  opacity: controller.isOpen.isTrue ? 0.0 : 1.0,
                        ...
                        onTap: () {
                          ...
                          _forexController.addTrade(
                            ...
                            marketValue: _forexController.isOpen.isTrue
                                ? _forexController.bookValueController.text
                                : _forexController.marketValueController.text,
