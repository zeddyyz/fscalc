                ...
                expanded: Padding(
                  ...
                  child: ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      var list = _availableOptionCurrency.entries.toList();
                      return Container(
                        ...
                        child: CustomOutlineButton(
                          ...
                          onTap: () async {
                            ...
                            storageBox.write(
                                "currencyPreference", list[index].key);
                            storageBox.write(
                                "currencySymbol", list[index].value);
                          },
                        ),
                      );
                    },
                  ...
                  children: [
                    Padding(
                      ...
                      child: ListView.builder(
                        ...
                        padding: const EdgeInsets.all(0),
                        itemBuilder: (context, index) {
                          var list = _availableOptionChart.entries.toList();
                          return Container(
                            margin: const EdgeInsets.only(bottom: 12),
                            child: CustomOutlineButton(
                              ...
                              onTap: () async {
                                ...
                                storageBox.write(
                                    "chartPreference", list[index].value);
                              },
                            ),
                          );
                        },
