...
class _ForexIsClosedWidgetState extends State<ForexIsClosedWidget> {
  ...
  editTradeModalBottomSheet({
    ...
    forexController.isOpen.value = isOpen;
    forexController.instrument = RxString(currencyPair);
    forexController.entryDate = RxString(entryDate.toString());
    forexController.bookValueController.text = bookValue;
    forexController.exitDate = RxString(exitDate.toString());
    forexController.marketValueController.text = marketValue;
              ...
              return child =
                ...
                Future entryDateTimePicker() async {
                  MaterialColor colorCustom = MaterialColor(
                      0xffB61131, forexController.dateSelectionMaterialColor);
                    ...
                    children: [
                        ...
                        children: [
                          ...
                          Padding(
                            ...
                            child: GestureDetector(
                              onTap: () {
                                forexController.resetFormEditValues();
                              },
                        ...
                        child: Padding(
                          ...
                          child: ListView(
                            ...
                            children: [
                              Container(
                                ...
                                child: DropdownButtonFormField2(
                                  ...
                                  hint: Padding(
                                    ...
                                    child: Text(
                                      forexController.instrument.string,
                                      style: const TextStyle(
                                        fontSize: 16,
                                        fontWeight: FontWeight.w500,
                                  ...
                                  items: forexController.currencyPairs
                                      .map(
                                  ...
                                  onChanged: (value) {
                                    forexController.instrumentEdit =
                                ...
                                children: [
                                  Expanded(
                                    child: ListTile(
                                      ...
                                      title: Obx(
                                        () => Text(
                                          "Current: ${forexController.readableDatefromMilliseconds(int.parse(forexController.entryDate.string))}",
                                          style: const TextStyle(
                                            fontWeight: FontWeight.w600,
                                          ),
                                        ),
                                      ...
                                      subtitle: Obx(
                                        () => Text(
                                          "New: ${forexController.convertStringToDateTime(forexController.entryDateEdit.string)}",
                                        ),
                                      ),
                                    ),
                                  ),
                              ...
                              CustomTextField(
                                controller:
                                    forexController.bookValueControllerEdit,
                                hintText:
                                    "Book value: \$${forexController.bookValueController.text}",
                              ...
                              ListTile(
                                ...
                                trailing: Obx(
                                  () => Switch.adaptive(
                                    value: forexController.isOpen.value,
                                    activeColor: kThemeRed.withOpacity(0.7),
                                    onChanged: (val) {
                                      forexController.toggleIsOpen();
                                    },
                                  ),
                                ),
                              ),
                                    ...
                                    child: Column(
                                      children: [
                                          ...
                                          children: [
                                            Expanded(
                                              child: ListTile(
                                                ...
                                                title: Text(
                                                  "Curernt: ${controller.readableDatefromMilliseconds(
                                                    int.parse(forexController
                                                        .exitDate.string),
                                                  )}",
                                                  style: const TextStyle(
                                                    fontWeight: FontWeight.w600,
                                                ...
                                                subtitle: Text(
                                                  "New: ${controller.convertStringToDateTime(forexController.exitDateEdit.string)}",
                                                ),
                                              ),
                                            ),
                                            const SizedBox(width: 4),
                                        ...
                                        CustomTextField(
                                          ...
                                          hintText:
                                              "Market value: \$${controller.marketValueController.text}",
                                          hintTextColor:
                      ...
                      Container(
                        ...
                        child: CustomButton(
                          ...
                          onTap: () {
                            forexController.editTrade(
                              id: id,
                              currencyPair:
                                  forexController.instrumentEdit.string,
                              entryDate: DateTime.parse(
                                  forexController.entryDateEdit.string),
                              exitDate: forexController.isOpenEdit.isTrue
                                  ? DateTime.parse(
                                      forexController.entryDateEdit.string)
                                  : DateTime.parse(
                                      forexController.exitDateEdit.string),
                              bookValue:
                                  forexController.bookValueControllerEdit.text,
                              marketValue: forexController.isOpenEdit.isTrue
                                  ? forexController.bookValueControllerEdit.text
                                  : forexController
                                      .marketValueControllerEdit.text,
                              isOpen: forexController.isOpenEdit.value,
                            );
